         ...
         <% 
               try{   
            	Statement statementNote=con.createStatement();
            	  PreparedStatement st = con.prepareStatement("SELECT * FROM notes where dept = ? and class = ? and subject = ?");
        
	            st.setString(1,request.getParameter("dept-name"));
	            st.setString(2,request.getParameter("sem"));
            ...
            <div class="dpt w-full text-center mx-auto pt-10 pb-3 sm:w-96 rounded-md text-white my-5 mx-2"
